...
process DOWNLOAD_HUMAN_G1K_V37{
    ...
    output:
    path("human_g1k_v37.{fasta,fasta.fai}")

    """
    wget ftp://ftp.1000genomes.ebi.ac.uk/vol1/ftp/technical/reference/human_g1k_v37.fasta.gz && gunzip human_g1k_v37.fasta.gz
